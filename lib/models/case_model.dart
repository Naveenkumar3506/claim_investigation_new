...
class CaseModel {
  ...
  factory CaseModel.fromJson(Map<String, dynamic> json) => CaseModel(
      ...
      insuredDod:
          DateFormat('yyyy-MM-ddThh:mm:ss.000+00:00').parse(json["insuredDOD"]),
      insuredDob:
          DateFormat('yyyy-MM-ddThh:mm:ss.000+00:00').parse(json["insuredDOB"]),
  ...
  factory CaseModel.fromMap(Map<String, dynamic> json) => CaseModel(
      caseId: json["caseId"],
      policyNumber: json["policyNumber"],
      investigation: Investigation.fromJson(jsonDecode(json["investigation"])),
      insuredName: json["insuredName"],
      insuredDod:
          DateFormat('yyyy-MM-ddThh:mm:ss.000+00:00').parse(json["insuredDOD"]),
      insuredDob:
