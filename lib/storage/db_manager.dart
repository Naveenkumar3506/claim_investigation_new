...
class DbManager {
  ...
  _initDB() async {
    ...
    return await openDatabase(path, version: _databaseVersion, onOpen: (db) {},
      ...
      await db.execute(
          "CREATE TABLE $caseTable (caseId INTEGER PRIMARY KEY, policyNumber TEXT, investigationType TEXT, insuredName TEXT, insuredDOD TEXT, insuredDOB TEXT, sumAssured REAL, location TEXT, caseStatus TEXT, caseSubStatus TEXT, nominee_Name TEXT, nominee_ContactNumber TEXT, nominee_address TEXT, pincode TEXT, insured_address TEXT, case_description TEXT, longitude TEXT, latitude TEXT, case_Docs TEXT , capturedDate TEXT, createdBy TEXT, createdDate TEXT, updatedDate TEXT, updatedBy TEXT, remarks TEXT, newRemarks TEXT ,fromUser TEXT, caseMovementStatus TEXT, gender TEXT, insuredMob TEXT, insuredDiagnosisDate TEXT, investigationNature TEXT, forms Text)");
      await db.execute(
  ...
  Future<int> insert(
      String table, Map<String, dynamic> row, bool isReplace) async {
    Database db = await database;
    print('insert into $table');
    return await db.insert(table, row,
        conflictAlgorithm: isReplace == true
