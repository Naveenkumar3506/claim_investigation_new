...
//                 onPressed: () async {
//                    final status = await Get.toNamed(PIVFormsScreen.routeName, arguments: {"pivAnswers":  Provider.of<ClaimProvider>(context,
//                        listen: false).pivAnswers, "caseId": _caseModel.caseId});
//                    print("");
